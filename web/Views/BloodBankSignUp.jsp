<%-- 
    Document   : BloodBankSignUp
    Created on : Dec 30, 2021, 7:15:39 AM
            ...
            <div class="row no-gutters">
                ...
                <div class="col-6">
                    <div class="form-row pt-2">
                        <h1 class="font-weight-bold py-3 px-12">Sign Up Blood Bank</h1> 
                    </div>
                    ...
                    <form action="${pageContext.request.contextPath}/SignUpNewUsers" method="post">
                        <div class="row no-gutters form-row">
                            ...
                            <div class="col-8 ">
                                <input name="name" type="text" placeholder="Enter Blood bank name" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row no-gutters form-row">
                            ...
                            <div class="col-8">
                                <input name="bloodGroup" type="text" placeholder="Enter blood Group" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <input type="hidden"  name="userType" value="bloodbank">
