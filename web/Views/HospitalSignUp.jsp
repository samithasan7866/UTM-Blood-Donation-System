<%-- 
    Document   : HospitalSignUp
    Created on : Dec 30, 2021, 7:12:58 AM
      ...
      <section class="form">
        <div class="container">
          <div class="row no-gutters">
            <div class="col-6">
              <img src="img/hospital.png" alt="" class="img-fluid" />
            </div>

            <div class="col-6">
              <div class="form-row pt-2">
                <h1 class="font-weight-bold py-3 px-12">
                  Sign Up New Hospital
                </h1>
              </div>
